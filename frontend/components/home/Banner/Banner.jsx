        ...
        <>
            ...
            >
                <div className="relative">
                    <div className="absolute w-full h-full bg-gradient-to-r from-white-600/10 to-white-600/10 bottom-0  z-20" />
                    
                    <Image src={home1} className="home1Img" width={1000} height={1000}/>
                    <div>
