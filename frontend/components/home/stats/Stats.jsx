...
import people1 from "../../../public/img/people1.svg";
    ...
    <div className="py-9 bg-#E5E5E5">
      <div className="flex items-center justify-center mx-20 my-[150px]">
        <div className="flex flex-1 flex-col justify-center items-center">
          <Image className="statsImg" src={people1} alt="" width={500} height={500}/>
        ...
        <div className="flex flex-1 flex-col justify-center items-center">
          <Image className="statsImg" src={people} alt="" width={500} height={500}/>
        ...
        <div className="flex flex-1 flex-col justify-center items-center">
          <Image className="makeUp1" src={Frame3} alt="" width={500} height={500} />
